...
function NewRestaurantCard(props) {
  ...
  const heart =
    profile
      ? profile.favourite.includes(props?._id)
      : false
  ...
  const handleAddToFavorites = event => {
    /*
      Prevent this tap from also triggering
      the restaurant card navigation.
    */
            ...
            >
              ...
              >
                <AntDesign
                  ...
                  size={14}
                  color={
                    currentTheme.editProfileButton
                  }
                />
